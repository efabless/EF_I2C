// *******************************************************************************************************
// **                                                                                                   **
// **   24AA64.v - Microchip 24AA64 64K-BIT I2C SERIAL EEPROM (VCC = +1.7V TO +5.5V)                    **
// **                                                                                                   **
// *******************************************************************************************************
// **                                                                                                   **
...
module M24AA64 (A0, A1, A2, WP, SDA, SCL, RESET);
...
//      1.06:  Byte Address Register
// -------------------------------------------------------------------------------------------------------
   reg read_address_0, read_address_1 = 0;
   always @(negedge SCL) begin
      read_address_1 <= 0;
